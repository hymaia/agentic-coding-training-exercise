...
3. **Workflow** — Ordered steps to execute the work, with particular emphasis on tests and automated checks (e.g., implement, test, lint, compile, run, deploy — or any project-specific variation). Better if they are listed in a checklist format.
