...
**Goal**
Validate that the project's agent instruction file (CLAUDE.md or AGENTS.md at project root or in the current context) contains adequate context for AI assistants to work effectively with this codebase.
